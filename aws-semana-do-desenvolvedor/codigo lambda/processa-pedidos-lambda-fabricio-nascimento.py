...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        try:
            ...
            # Simular logica de processamento
            status_processamento = "PEDIDO_PROCESSADO"
            print(f"Logica de processamento para pedido {pedido_id} concluÃ­da (simulada).")
            ...
            # Usar pedido_data se ja foi definido, ou usar o corpo SQS bruto
